...
class _ManageServicesScreenState extends State<ManageServicesScreen> {
  ...
  Future<void> _saveService() async {
    ...
    if (success && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(productProvider.errorMessage ?? 'Operation failed'),
        ),
      );
    }
  }
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child:
                        (_selectedImageBytes == null &&
                            (product == null || product.imageUrls.isEmpty))
                        ? Column(
                          ...
                          Stack(
                            children: [
                              CustomImageWidget(
                                ...
                                fit: BoxFit.cover,
                                semanticLabel:
                                    'Service image for ${product.title}',
                              ),
                              Positioned(
                                top: 12,
                                left: 12,
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    OutlinedButton.icon(
                                      onPressed: () =>
                                          _showServiceForm(product: product),
                                      icon: const Icon(
                                        Icons.edit_rounded,
                                        size: 16,
                                      ),
